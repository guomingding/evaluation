<template>
  <div class="baseline1">
      ...
      <p>For this task you will be asked a series of questions about the behavior of the code.
        ...
        <el-row>
            <el-button round class="baseline1Btn" style="background-color:purple" @click="parsePage">Parse</el-button>
            <el-button round class="baseline1Btn" style="background-color:green" :disabled="!allowSubmit" @click="submit">Submit</el-button>
        </el-row>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    submit(){
      ...
      this.$store.commit('setBaseline1',this.answers)
      this.$router.push('/baseline2') 
